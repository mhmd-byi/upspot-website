...
const Meta = ({ title, description, pageUrl = "" }) => {
  ...
  return (
    <Helmet>
      ...
      <meta
        name="keywords"
        content="digital marketing agency in indore, digital marketing company, web development company, best seo company, social media marketing agency, ecommerce website development, website designing services, paid marketing, marketplace product management, graphic designer near me, graphic designing services"
      />
    ...
    })(window, document, "clarity", "script", "mkkz4n7ad5");`}
    </script>
    </Helmet>
  );
};
...
Meta.defaultProps = {
  ...
  description:
    "UpSpot: Your Premier Digital Marketing Agency in Indore! Elevate your online presence with our expert SEO, social media, PPC, and web design services. Let's boost your business together.",
};
